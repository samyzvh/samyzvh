...
🌼 Estudante encantada por Java e a lógica por trás dos sistemas.<br><br>
🌱 Em breve iniciarei o curso de Análise e Desenvolvimento de Sistemas.<br><br>
🔭 Finalizando os estudos de Lógica de Programação e Algoritmos.<br><br>
⚡ Tenho foco em desenvolver sistemas robustos e entender a arquitetura Back-end.<br><br>
✨ "Programação não é sobre o que você sabe; é sobre o que você consegue descobrir." — Chris Pine<br><br>
</div>
</div>
